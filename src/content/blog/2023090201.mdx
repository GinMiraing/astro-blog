...
description: 我刚开始写 React 的时候，并不知道如何优化组件的性能，直接 useState 一把梭。在后续的开发中，我发现有两个 React Hook 可以对组件进行缓存，useMemo 可以缓存数据，useCallback 可以缓存函数，于是我就把所有的数据和函数都用这两个 Hook 包裹住，这也是所有新手会做的事。
author: 胤
category: 技术
id: 20
---
